...
# 0.01 #5.00000000000001e-2 #
local_t = 0.01 # np.linspace(0 , 5.00000000000001e-2, 100)
local_var_1 = np.linspace(-1 , 1, 100)
local_var_2 = np.linspace(-1 , 1, 100)
local_var_3 = np.linspace(-1 , 1, 100)
local_var_4 = np.linspace(-1 , 1, 100)

#x = min(max(1.18098379999999e1 , 1.18098380000000e1) + max(1.96340000000017e-2 , 1.96340000000018e-2) * local_var_1) +min( max(6.02028462894221 , 6.02028462894222) * local_t + max(5.76388582004170e-2 , 5.76388582004171e-2) * local_t * local_var_3 + max(-4.75503718193853e-4 , -4.75503718193852e-4) * local_t * local_var_3**2 + max(-1.51750806238111e-6 , -1.51750806238110e-6) * local_t * local_var_3**3 + max(6.25949878762642e-9 , 6.25949878762643e-9) * local_t * local_var_3**4 + max(1.19858241017775e-11 , 1.19858241017776e-11) * local_t * local_var_3**5 + max(-3.29598474822637e-14 , -3.29598474822636e-14) * local_t * local_var_3**6 + max(-4.66504769262686e-5 , 4.66504769262686e-5))
x = min(max(2.50000000000000 , 2.50000000000000) + max(5.00000000000000e-1 , 5.00000000000000e-1) * local_var_1) + min( max(4.53596121425577e1 , 4.53596121425578e1) * local_t + max(-8.91207360061435 , -8.91207360061434) * local_t * local_var_3 + max(-2.26798060712789e-1 , -2.26798060712788e-1) * local_t * local_var_3**2 + max(1.48534560010238e-2 , 1.48534560010239e-2) * local_t * local_var_3**3 + max(1.88998383927322e-4 , 1.88998383927323e-4) * local_t * local_var_3**4 + max(-7.42672800051192e-6 , -7.42672800051191e-6) * local_t * local_var_3**5 + max(-6.29994613091075e-8 , -6.29994613091074e-8) * local_t * local_var_3**6 + max(1.76826857155045e-9 , 1.76826857155046e-9) * local_t * local_var_3**7 + max(1.12499038051977e-11 , 1.12499038051978e-11) * local_t * local_var_3**8 + max(-2.45592857159785e-13 , -2.45592857159784e-13) * local_t * local_var_3**9 + max(-9.41129619104088e-5 , 9.41129619103963e-5))


x_max = max(max(2.50000000000000 , 2.50000000000000) + max(5.00000000000000e-1 , 5.00000000000000e-1) * local_var_1) + max( max(4.53596121425577e1 , 4.53596121425578e1) * local_t + max(-8.91207360061435 , -8.91207360061434) * local_t * local_var_3 + max(-2.26798060712789e-1 , -2.26798060712788e-1) * local_t * local_var_3**2 + max(1.48534560010238e-2 , 1.48534560010239e-2) * local_t * local_var_3**3 + max(1.88998383927322e-4 , 1.88998383927323e-4) * local_t * local_var_3**4 + max(-7.42672800051192e-6 , -7.42672800051191e-6) * local_t * local_var_3**5 + max(-6.29994613091075e-8 , -6.29994613091074e-8) * local_t * local_var_3**6 + max(1.76826857155045e-9 , 1.76826857155046e-9) * local_t * local_var_3**7 + max(1.12499038051977e-11 , 1.12499038051978e-11) * local_t * local_var_3**8 + max(-2.45592857159785e-13 , -2.45592857159784e-13) * local_t * local_var_3**9 + max(-9.41129619104088e-5 , 9.41129619103963e-5))

#x = max(max(1.18098379999999e1 , 1.18098380000000e1) + max(1.96340000000017e-2 , 1.96340000000018e-2) * local_var_1) +max( max(6.02028462894221 , 6.02028462894222) * local_t + max(5.76388582004170e-2 , 5.76388582004171e-2) * local_t * local_var_3 + max(-4.75503718193853e-4 , -4.75503718193852e-4) * local_t * local_var_3**2 + max(-1.51750806238111e-6 , -1.51750806238110e-6) * local_t * local_var_3**3 + max(6.25949878762642e-9 , 6.25949878762643e-9) * local_t * local_var_3**4 + max(1.19858241017775e-11 , 1.19858241017776e-11) * local_t * local_var_3**5 + max(-3.29598474822637e-14 , -3.29598474822636e-14) * local_t * local_var_3**6 + max(-4.66504769262686e-5 , 4.66504769262686e-5))

#print  ( max(4.53596121425577e1 , 4.53596121425578e1) * local_t + max(-8.91207360061435 , -8.91207360061434) * local_t * local_var_3 + max(-2.26798060712789e-1 , -2.26798060712788e-1) * local_t * local_var_3**2 + max(1.48534560010238e-2 , 1.48534560010239e-2) * local_t * local_var_3**3 + max(1.88998383927322e-4 , 1.88998383927323e-4) * local_t * local_var_3**4 + max(-7.42672800051192e-6 , -7.42672800051191e-6) * local_t * local_var_3**5 + max(-6.29994613091075e-8 , -6.29994613091074e-8) * local_t * local_var_3**6 + max(1.76826857155045e-9 , 1.76826857155046e-9) * local_t * local_var_3**7 + max(1.12499038051977e-11 , 1.12499038051978e-11) * local_t * local_var_3**8 + max(-2.45592857159785e-13 , -2.45592857159784e-13) * local_t * local_var_3**9 + max(-9.41129619104088e-5 , 9.41129619103963e-5))
